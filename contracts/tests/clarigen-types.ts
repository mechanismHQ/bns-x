...
export const contracts = {
  bnsV1: {
    ...
    'maps': {
      namePreorders: {
        'name': 'name-preorders',
        'key': {
          'tuple': [{ 'name': 'buyer', 'type': 'principal' }, {
            'name': 'hashed-salted-fqn',
            'type': { 'buffer': { 'length': 20 } },
          }],
        },
        'value': {
          'tuple': [{ 'name': 'claimed', 'type': 'bool' }, {
            'name': 'created-at',
            'type': 'uint128',
  ...
  bnsxExtensions: {
    'functions': {
      ...
      requestExtensionCallback: {
        ...
        'access': 'public',
        'args': [{ 'name': 'extension', 'type': 'trait_reference' }, {
          'name': 'memo',
    ...
    'maps': {
      ...
      extensionRoles: {
        ...
        'key': {
          'tuple': [{ 'name': 'extension', 'type': 'principal' }, {
            'name': 'role',
            'type': { 'string-ascii': { 'length': 10 } },
          }],
        },
  ...
  bnsxRegistry: {
    ...
    'maps': {
      ...
      namespaceManagersMap: {
        ...
        'key': {
          'tuple': [{ 'name': 'manager', 'type': 'principal' }, {
            'name': 'namespace',
            'type': { 'buffer': { 'length': 20 } },
          }],
        },
  ...
  fakeFt: {
    'functions': {
      ...
      getTokenUri: {
        ...
        'outputs': {
          'type': {
            'response': { 'ok': { 'optional': 'none' }, 'error': 'none' },
          },
        },
  ...
  nameWrapperV2: {
    'functions': {
      ...
      withdrawFt: {
        'name': 'withdraw-ft',
        'access': 'public',
        'args': [{ 'name': 'ft', 'type': 'trait_reference' }, {
          'name': 'amount',
          'type': 'uint128',
        }, { 'name': 'recipient', 'type': 'principal' }],
        'outputs': {
      ...
      withdrawNft: {
        'name': 'withdraw-nft',
        'access': 'public',
        'args': [{ 'name': 'nft', 'type': 'trait_reference' }, {
          'name': 'token-id',
          'type': 'uint128',
        }, { 'name': 'recipient', 'type': 'principal' }],
        'outputs': {
  ...
  queryHelper: {
    'functions': {
      ...
      } as TypedAbiFunction<[account: TypedAbiArg<string, 'account'>], {
        'names': {
          'id': bigint;
          'legacy': {
            'leaseEndingAt': bigint | null;
        ...
        'outputs': {
          'type': {
            'response': {
              'ok': 'principal',
              'error': {
                'tuple': [{ 'name': 'error_code', 'type': 'uint128' }, {
                  'name': 'value',
...
export const identifiers = {
  ...
  'wrapperMigratorV2':
    'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.wrapper-migrator-v2',
} as const;
