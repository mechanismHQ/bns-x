...
describe('l1-bridge-v1', () => {
  ...
  function hashWrapData(nameId: bigint, header: Uint8Array, inscriptionId: Uint8Array) {
    return chain.rov(
  ...
  function signWrap(
    ...
    const hash = hashWrapData(nameId, header, inscriptionId);
  ...
  describe('successful wrap', () => {
    ...
    it('calls `wrap` method', () => {
      const signature = signWrap(nameId, hash, inscriptionId);
  ...
  describe('wrap validation', () => {
    ...
    it('fails if invalid signer', () => {
      ...
      const signature = signWrap(nameId, hash, inscriptionId, alicePK);
