...
(define-public (name-register 
  ...
  (begin
    (try! (contract-call? 'ST000000000000000000002AMW42H.bns name-preorder hashed-fqn amount))
    (try! (contract-call? 'ST000000000000000000002AMW42H.bns name-register namespace name salt 0x))
    (print {
